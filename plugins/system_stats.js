...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'vgfg', fromMe: true, desc: Lang.ALIVE_DESC}, (async (message, match) => {
   ...
   Asena.addCommand({pattern: 'vgfg', fromMe: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
