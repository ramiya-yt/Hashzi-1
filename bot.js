...
async function whatsAsena () {
    ...
    setInterval(async () => { 
        ...
        await axios.get('https://gist.githubusercontent.com/xneon2/9d3834f9ca0098024199df591ca89df2/raw').then(async (ann) => {
...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please Wait.')}`);
    ...
    conn.on('credentials-updated', async () => {
        ...
        console.log(chalk.bgGreen('🎭ɴᴇᴏᴛʀᴏ𝙭🪐' + afwhasena));
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [*🎭ɴᴇᴏᴛʀᴏ𝙭🪐*] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
