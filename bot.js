...
async function whatsAsena () {
    ...
    setInterval(async () => { 
        ...
        await axios.get('https://gist.github.com/tenuh/5a43cd2438416abe41a6eb4232c7c742/raw/').then(async (ann) => {
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- බොට් වාර්තාව [NEOTRO-X🎭🙇] --*\n' + 
                                    ...
                                    '\n_අපගේ සහය සමූහය, https://chat.whatsapp.com/GTgqgMTo7FoJ1GqdijshsX_\n\n' +
                                    '*Report:* ```' + error + '```\n\n'
                                    , MessageType.text);
                            }
                        }
